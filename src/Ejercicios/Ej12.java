...
public class Ej12 {
	...
	public static void main(String[] args) {
		...
		// 12.Programa que lea un número entero N de 5 cifras y muestre sus cifras desde el principio como en el ejemplo.Por ejemplo, para un 		número N = 12345     La salida debe ser:1 12 123 1234 12345 
